...
class beam():
    ...
    def plot_moment(self):
        self.update()
        plt.figure('Diagrama de Momento Fletor', figsize=(18,5), dpi=100)
        ...
        # Settings
        plt.xlabel('Tamanho da Viga (m)')
        plt.ylabel('Momento Fletor (kN/m)')
        plt.title(f'Diagrama de Momento Fletor - ({self.name})')
    ...
    def plot_shear(self):
        self.update()
        plt.figure('Diagrama de Esforço Cortante', figsize=(18,5), dpi=100)
        ...
        plt.title(f'Diagrama de Esforço Cortante - ({self.name})')
    ...
    def plot_load(self):
        # plt.figure(name)
        plt.figure('Diagrama de Carga', figsize=(18,5), dpi=100)
        ...
        # Settings
        plt.xlabel('Tamnho da Viga (m)')
        plt.ylabel('Carga (kN)')
        plt.title(f'Diagrama de Carga - ({self.name})')
